...
(re-frame/reg-event-fx
 ...
 (fn [{:keys [db]} [_ editing-movie-review]]
   (let [form-data (:movie-review-form db)
         ...
         request (if editing-movie-review (set/rename-keys prepare-movie-review-date {:date_of_review "date-of-review"}) (set/rename-keys prepare-movie-review-date {:date_of_review "date-of-review" :movie_id "movie-id" :author_id "author-id"}))
